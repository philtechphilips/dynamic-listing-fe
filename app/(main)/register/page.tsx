        ...
        try {
            if (signupMethod === 'password') {
                const res = await fetch('http://localhost:8007/api/v1/auth/signup', {
                    ...
                    body: JSON.stringify({ name, email: formEmail, password }),
                });
            ...
            <div className="max-w-md w-full bg-white p-10 rounded-2xl shadow-xl">
                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-gray-100 p-1 rounded-xl flex">
                        <button
                            type="button"
                            onClick={() => { setSignupMethod('password'); setStep('initial'); }}
                            className={`flex-1 py-2 text-sm font-medium rounded-lg transition-all duration-200 ${signupMethod === 'password'
                        ...
                        <button
                            ...
                            className={`flex-1 py-2 text-sm font-medium rounded-lg transition-all duration-200 ${signupMethod === 'otp'
                                ? 'bg-white text-gray-900 shadow-sm'
                                : 'text-gray-500 hover:text-gray-900'
                                }`}
                        >
                        ...
                        <div>
                            ...
                            >
                                {isLoading ? 'Processing...' : (
                                    signupMethod === 'password'
                                        ? 'Create Account'
                                        : (step === 'initial' ? 'Send Verification Code' : 'Verify Code')
                                )}
                            </Button>
                        </div>
                    </form>
