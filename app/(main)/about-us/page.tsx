    ...
    <div className="container mx-auto px-4 pt-32 pb-16 max-w-4xl">
      ...
      <div className="prose dark:prose-invert max-w-none space-y-6 text-lg text-gray-600 dark:text-gray-300">
        <p>
          ...
          service to our users. Our mission is to simplify your life with our
          innovative solutions.
        </p>
        <p>
          Founded in 2024, our team has been working effectively to bring you a
          seamless experience. We believe in quality, integrity, and customer
          satisfaction.
        </p>
        <p>
        ...
        <h2 className="text-2xl font-semibold mt-8 text-gray-800 dark:text-gray-100">
          Our Vision
        </h2>
        <p>
